...
Il metodo di installazione differisce dalla piattaforma su cui |product| è installato.

|product_nethserver|
====================

È possibile eseguire l'installazione tramite l'interfaccia web di |product_nethserver|.
Successivamente, dall'interfaccia grafica di |parent_product|, cliccare il pulsante :guilabel:`Applica cambiamenti`.
...
Per utilizzare la chat è necessario installare il modulo :guilabel:`Messaggistica istantanea` tramite l'interfaccia web di |product_nethserver|.

|product_nethservice| 8.2
=========================
...
Dall'interfaccia grafica di configurazione di |parent_product|, cliccare il pulsante :guilabel:`Applica cambiamenti`, se presente.
...
Prima di eseguire la migrazione aggiornare |product| su |product_nethservice| all'ultima versione disponibile. 
Seguire quindi la `guida di migrazione |product_nethserver| <http://nethserver.docs.nethesis.it/it/v7/migration.html>`_
